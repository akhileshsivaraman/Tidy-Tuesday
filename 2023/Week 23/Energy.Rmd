...
- how has renewables generation changed (as a percentage and watts)? comparison to fossil fuels?
- how has renewables consumption changed? comparison to fossil fuels?
- UK trends by energy source (write function to do this for every country/region and make an app)
Renewables is the sum of energy from hydropower, wind, solar, geothermal, wave and tidal, and bioenergy
